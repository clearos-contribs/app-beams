...
echo field_dropdown('power', $power_options, $power, lang('beams_tx_power'), FALSE);
echo field_dropdown('network', $network_options, $network, lang('beams_network_config'), FALSE);
